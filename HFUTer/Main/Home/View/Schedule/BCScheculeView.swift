...
class BCScheculeView: EEXibView {
	...
	override func initFromXib() {
		...
		NotifCenter.addObserver(self, selector: "weekEndSettingChanged", name: EEUserChangedWeekEndSchdeuleSettingNotification, object: nil)
	}
	...
	@objc func weekEndSettingChanged() {
...
extension collectionViewLayout:UICollectionViewDelegateFlowLayout {
	func collectionView(collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAtIndexPath indexPath: NSIndexPath) -> CGSize {
		let width:CGFloat = (indexPath.row == 0) ? leftCellWidth :(ScreenWidth-leftCellWidth-1)/CGFloat(DataEnv.dayCount)
